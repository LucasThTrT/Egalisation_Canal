...
semilogy(Es_N0_dB,simBer_mlinf(1,:),'gs-','Linewidth',2);
axis([0 50 10^-6 0.5])
grid on
legend('sim-zf-direct','sim-zf-inf','sim-mmse-inf','sim-rif','sim-ML');
xlabel('E_s/N_0, dB');
ylabel('Bit Error Rate');
title('Bit error probability curve for QPSK in ISI with ZF MMSE RIF and ML equalizers')
